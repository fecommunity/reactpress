...
const STRINGS = {
  en: {
    ...
    'dev.phaseApi': 'Starting API (port 3002)…',
    'dev.phaseAdmin': 'Starting admin SPA (internal :5173/admin/)…',
    ...
    'dev.waitingProxies': 'Waiting for admin & theme dev servers…',
    'dev.startingAdmin': '[reactpress] Admin dev server → {url}',
    'dev.adminNginxSlow': '[reactpress] Admin via nginx not ready: {url} — ensure Vite base is /admin/ (restart pnpm dev)',
    'dev.nginxReady': '[reactpress] Nginx ready — {url}',
    'dev.proxiesReady': '[reactpress] Admin & theme dev servers are up',
    ...
    'dev.waitingApi': '[reactpress] Waiting for API health: {url}',
    ...
    'themeDev.invalidManifest': 'Ignored invalid active-theme.json (only themes/ or templates/ packages apply)',
    ...
    'dev.apiReadyAdmin': '[reactpress] API ready, starting admin SPA…',
    ...
    'devBanner.nginxHint': 'Internal ports 3001/5173/3002 — use URLs above only',
  ...
  zh: {
    ...
    'dev.phaseApi': '启动 API（端口 3002）…',
    'dev.phaseAdmin': '启动管理后台（内部 :5173/admin/）…',
    ...
    'dev.waitingProxies': '等待管理后台与主题开发服务…',
    'dev.startingAdmin': '[reactpress] 管理后台开发服务 → {url}',
    'dev.adminNginxSlow': '[reactpress] 经 nginx 访问管理端未就绪: {url} — 请确认 Vite base 为 /admin/（重新执行 pnpm dev）',
    'dev.nginxReady': '[reactpress] Nginx 已就绪 — {url}',
    'dev.proxiesReady': '[reactpress] 管理后台与主题开发服务已就绪',
    ...
    'dev.waitingApi': '[reactpress] 等待 API 健康检查: {url}',
    ...
    'themeDev.invalidManifest': '已忽略无效的 active-theme.json（仅 themes/ 或 templates/ 下的主题包会生效）',
    ...
    'dev.apiReadyAdmin': '[reactpress] API 已就绪，正在启动管理后台…',
    ...
    'devBanner.nginxHint': '内部端口 3001/5173/3002 仅作转发，请只使用上方地址',
