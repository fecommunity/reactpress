...
const STRINGS = {
  en: {
    ...
    'cli.nginx.description': 'Nginx reverse proxy (unified entry on :8080)',
    ...
    'cli.help.nginx': '  reactpress nginx up          Start reverse proxy (:8080)',
    ...
    'menu.nginxUp': 'Start nginx reverse proxy (:8080)',
    'menu.nginxOpen': 'Open nginx entry in browser',
    'menu.nginxReload': 'Reload nginx after editing config',
    'menu.hint.nginxUp': 'unified entry :8080',
    'menu.hint.nginxOpen': 'http://localhost:8080',
  ...
  zh: {
    ...
    'cli.nginx.description': 'Nginx 反向代理（统一入口 :8080）',
    ...
    'cli.help.nginx': '  reactpress nginx up          启动反向代理 (:8080)',
