  ...
  try {
    ...
    try {
      ...
      if (pkg.path === 'cli') {
        ...
        pkg.path === 'themes/hello-world' ||
        pkg.path === 'themes/twentytwentyfive'
      ) {
...
async function main() {
  ...
  if (args.includes('--publish')) {
    ...
    console.log('Usage:');
    console.log('  reactpress publish --build     Build all packages');
    console.log('  reactpress publish --publish   Publish packages (interactive)');
    console.log('');
  }
}

module.exports = { main, buildPackages, publishPackages };
