...
const STRINGS = {
  en: {
    'cli.description':
      'ReactPress 4 — zero-dependency publishing platform. Run `reactpress init` to launch.',
    ...
    'init.useInitOnly': 'ReactPress 4 supports only: reactpress init',
  ...
  zh: {
    'cli.description': 'ReactPress 4 — 零依赖发布平台。运行 reactpress init 即可启动。',
    ...
    'init.useInitOnly': 'ReactPress 4 仅支持：reactpress init',
