...
const STRINGS = {
  en: {
    'cli.description':
      'ReactPress 4 — zero-dependency publishing platform. Run `reactpress init` or `reactpress doctor`.',
    'cli.init.description': 'Initialize and start ReactPress (SQLite API + admin + theme)',
    ...
    'cli.doctor.showLogs': 'Show recent API error logs after diagnostics',
    'cli.doctor.logs.description': 'View recent API logs (error, request, response)',
    'cli.doctor.logs.tailOption': 'Number of lines to show per log file',
    'cli.doctor.logs.sourceOption': 'Log source: error, request, response, or all',
    'cli.doctor.logs.grepOption': 'Filter log lines by regex',
    'cli.doctor.logs.listOption': 'List available log files only',
    'cli.logs.description': 'View API logs (PM2 process output or structured error/request/response)',
    'cli.logs.descriptionAlias': 'View API logs (alias of reactpress logs)',
    'cli.logs.tailOption': 'Number of lines to show per log file',
    'cli.logs.sourceOption': 'Log source: process (PM2), error, request, response, or all',
    'cli.logs.grepOption': 'Filter log lines by regex',
    'cli.logs.listOption': 'List available log files only',
    'cli.logs.followOption': 'Stream logs continuously (PM2 when supervised, otherwise tail -f)',
    'cli.stop.description': 'Stop API and site services started by init',
    ...
    'cli.start.description': 'Start ReactPress (SQLite API + admin + theme)',
    'cli.help.examples': 'Usage:',
    'cli.help.init': '  reactpress init [dir]        Initialize project',
    'cli.help.doctor': '  reactpress doctor            Diagnose environment issues',
    'cli.help.logs': '  reactpress logs              Tail API logs for quick debugging',
    'cli.help.stop': '  reactpress stop              Stop the background API',
    'cli.help.doctorLogs': '  reactpress doctor logs       Alias of reactpress logs',
    'cli.help.zeroDep': '  Zero deps: Node.js 18+ only — no Docker, nginx, or MySQL',
    ...
    'init.readyTitle': 'ReactPress is running',
    'init.label.path': 'Path',
    'init.label.db': 'Database',
    'init.label.site': 'Site',
    'init.label.admin': 'Admin',
    'init.label.api': 'API',
    'init.hint': 'Login: admin / admin · Services run in background · Stop: reactpress stop · Logs: reactpress logs',
    ...
    'banner.tagline': 'Zero deps · SQLite · ship in ~60s',
    ...
    'banner.service.sqlite': 'SQLite',
    'banner.service.mysql': 'MySQL',
    'banner.service.server': 'Server',
    'banner.service.docker': 'Docker',
    'banner.service.nginx': 'Nginx',
    'banner.service.web': 'Web',
    'banner.nginxRunning': 'running',
    'banner.nginxStopped': 'stopped',
    'banner.feat.sqlite': 'SQLite',
    'banner.feat.plugins': 'Plugins',
    'banner.feat.desktop': 'Desktop',
    'banner.feat.themes': 'Themes',
    ...
    'banner.systemPartial': 'PARTIAL',
    'banner.systemError': 'ERROR',
    'banner.systemPending': 'PENDING',
    'menu.dev': 'Full-stack dev',
    'menu.init': 'Initialize project',
    'menu.status': 'View project status',
    'menu.doctor': 'Environment check',
    'menu.devApi': 'API only (watch)',
    'menu.devClient': 'Frontend only',
    'menu.serverStart': 'Start API (production)',
    'menu.serverStop': 'Stop API',
    'menu.serverRestart': 'Restart API',
    'menu.build': 'Production build',
    ...
    'menu.section.quick': 'Quick start',
    'menu.section.explore': 'More',
    'menu.section.extend': 'Dev alternatives',
    'menu.section.lifecycle': 'Service control',
    'menu.section.build': 'Build & deploy',
    'menu.section.tools': 'Tools',
    'menu.group.extend': 'Dev alternatives',
    'menu.group.lifecycle': 'Service control',
    'menu.group.build': 'Build & deploy',
    'menu.group.tools': 'Tools & utilities',
    'menu.groupHint.extend': 'desktop · web · SQLite · themes',
    'menu.groupHint.lifecycle': 'API · frontend · start/stop',
    'menu.groupHint.build': 'build · Docker · publish',
    'menu.groupHint.tools': 'nginx · backup · admin',
    'menu.devDesktop': 'Desktop dev',
    'menu.hint.devDesktop': 'SQLite + Electron',
    'menu.devWeb': 'Admin SPA + API',
    'menu.hint.devWeb': 'web/ dev server',
    'menu.devLocalWeb': 'Local web',
    'menu.hint.devLocalWeb': 'SQLite in browser',
    'menu.initLocal': 'Initialize (SQLite)',
    'menu.hint.initLocal': 'no Docker',
    'menu.themeList': 'List themes',
    'menu.hint.themeList': 'theme list',
    'menu.pluginList': 'List plugins',
    ...
    'menu.shortcuts': '↑/↓ navigate  ·  1-9 quick pick  ·  enter select  ·  ctrl+c quit',
    ...
    'dev.autoLocalNoDocker':
      'Docker unavailable — auto-switching to local SQLite mode (no MySQL required)',
    'dev.autoLocalNoMysql': 'MySQL unreachable — auto-switching to local SQLite mode',
    ...
    'doctor.dockerSkipped': 'Docker not required (SQLite local mode)',
    ...
    'doctor.apiFixInit': 'Run reactpress init to start the API',
    'doctor.pnpmBad': 'pnpm not found',
    'doctor.pnpmFix': 'npm i -g pnpm, or enable corepack at monorepo root',
    'doctor.pnpmSkipped': 'pnpm optional (standalone / bundled runtime)',
    ...
    'doctor.check.site': 'Public site',
    'doctor.check.admin': 'Admin console',
    'doctor.siteOk': 'Site reachable at {url}',
    'doctor.siteBad': 'Site not reachable at {url}',
    'doctor.siteFix': 'Run reactpress init to start the theme frontend',
    'doctor.adminOk': 'Admin reachable at {url}',
    'doctor.adminBad': 'Admin not reachable at {url}',
    'doctor.adminFix': 'Run reactpress init, then open {url}',
    ...
    'doctor.logsHint': 'Tip: run reactpress logs --tail 100 to inspect API error logs',
    'logs.title': 'ReactPress Logs',
    'logs.subtitle': 'API log viewer',
    'doctor.logs.title': 'ReactPress Logs',
    'doctor.logs.subtitle': 'API log viewer',
    'doctor.logs.dir': 'Log dir   {path}',
    'doctor.logs.empty': 'No API log files found yet.',
    'doctor.logs.emptyHint':
      'Start the API with reactpress init — logs are written to .reactpress/logs/server/ (PM2 output: pm2-out.log / pm2-error.log)',
    'doctor.logs.listHeader': 'Available log files',
    'doctor.logs.fileHeader': '{file} (showing {count} line(s))',
    ...
    'doctor.logs.pm2Supervised': 'API supervised by PM2 (pid {pid})',
    'doctor.logs.pm2Unavailable': 'PM2 is not available for live log streaming.',
    'doctor.logs.followWindows': 'Live follow is not supported here. Open: {path}',
    ...
    'doctor.logs.moreHint':
      'Use --tail, --source, --grep, --follow, or --list for more control (see reactpress logs --help)',
    ...
    'lifecycle.apiExitedEarly': '[reactpress] API process exited early (pid {pid})',
    'lifecycle.apiReady': '[reactpress] API ready: {url}',
    'lifecycle.clientStopped': '[reactpress] Site process stopped (pid {pid})',
    'lifecycle.stopClientPidFailed': '[reactpress] Failed to stop site pid {pid}:',
    'lifecycle.clientAlreadyRunning': '[reactpress] Site already running (pid {pid})',
    'lifecycle.clientPidMissing': '[reactpress] Site failed to start (no pid recorded)',
    'lifecycle.waitingClient': 'Waiting for site at {url}…',
    'lifecycle.clientTimeout': '[reactpress] Site not ready within 180s: {url}',
    'lifecycle.clientExitedEarly': '[reactpress] Site process exited early (pid {pid})',
    'lifecycle.clientReady': '[reactpress] Site ready: {url} (pid {pid})',
    ...
    'lifecycle.processSupervisorFallback':
      '[reactpress] Process supervisor unavailable — falling back to background node start',
  ...
  zh: {
    'cli.description': 'ReactPress 4 — 零依赖发布平台。运行 reactpress init 或 reactpress doctor。',
    'cli.init.description': '初始化并启动 ReactPress（SQLite API + 管理后台 + 主题）',
    ...
    'cli.doctor.showLogs': '诊断结束后显示最近的 API 错误日志',
    'cli.doctor.logs.description': '查看 API 日志（error / request / response）',
    'cli.doctor.logs.tailOption': '每个日志文件显示的行数',
    'cli.doctor.logs.sourceOption': '日志类型：error、request、response 或 all',
    'cli.doctor.logs.grepOption': '用正则过滤日志行',
    'cli.doctor.logs.listOption': '仅列出可用日志文件',
    'cli.logs.description': '查看 API 日志（PM2 进程输出或结构化 error/request/response）',
    'cli.logs.descriptionAlias': '查看 API 日志（同 reactpress logs）',
    'cli.logs.tailOption': '每个日志文件显示的行数',
    'cli.logs.sourceOption': '日志类型：process（PM2）、error、request、response 或 all',
    'cli.logs.grepOption': '用正则过滤日志行',
    'cli.logs.listOption': '仅列出可用日志文件',
    'cli.logs.followOption': '持续输出日志（PM2 托管时用 pm2 logs，否则 tail -f）',
    'cli.stop.description': '停止 init 启动的 API 与站点服务',
    ...
    'cli.start.description': '启动 ReactPress（SQLite API + 管理后台 + 主题）',
    'cli.help.examples': '用法:',
    'cli.help.init': '  reactpress init [dir]        初始化项目',
    'cli.help.doctor': '  reactpress doctor            诊断环境问题',
    'cli.help.logs': '  reactpress logs              查看 API 日志，快速定位问题',
    'cli.help.stop': '  reactpress stop              停止后台 API',
    'cli.help.doctorLogs': '  reactpress doctor logs       reactpress logs 的别名',
    'cli.help.zeroDep': '  零依赖：仅需 Node.js 18+，无需 Docker、nginx 或 MySQL',
    ...
    'init.readyTitle': 'ReactPress 已启动',
    'init.label.path': '路径',
    'init.label.db': '数据库',
    'init.label.site': '站点',
    'init.label.admin': '后台',
    ...
    'banner.tagline': '零依赖 · SQLite · 约 60 秒上线',
    ...
    'banner.service.nginx': 'Nginx',
    'banner.service.web': 'Web',
    'banner.nginxRunning': '运行中',
    'banner.nginxStopped': '未运行',
    'banner.feat.sqlite': 'SQLite',
    'banner.feat.plugins': '插件',
    'banner.feat.desktop': 'Desktop',
    'banner.feat.themes': '主题',
    'banner.mode.standalone': '独立项目',
    'banner.mode.monorepo': 'MONOREPO',
    'banner.mode.uninitialized': '未初始化',
    'banner.systemLabel': '系统',
    'banner.systemOnline': '在线',
    'banner.systemPartial': '部分就绪',
    'banner.systemError': '异常',
    'banner.systemPending': '准备中',
    'menu.dev': '全栈开发',
    'menu.init': '初始化项目',
    'menu.status': '查看项目状态',
    'menu.doctor': '环境检查',
    'menu.devApi': '仅 API (watch)',
    'menu.devClient': '仅前端',
    'menu.serverStart': '启动 API (生产)',
    ...
    'menu.goodbye': '  再见。',
    'menu.section.run': '运行',
    'menu.section.quick': '快速开始',
    'menu.section.explore': '更多',
    'menu.section.extend': '开发替代方案',
    'menu.section.lifecycle': '服务控制',
    'menu.section.build': '构建与部署',
    'menu.section.tools': '工具',
    'menu.group.extend': '开发替代方案',
    'menu.group.lifecycle': '服务控制',
    'menu.group.build': '构建与部署',
    'menu.group.tools': '工具与实用功能',
    'menu.groupHint.extend': '桌面 · Web · SQLite · 主题',
    'menu.groupHint.lifecycle': 'API · 前端 · 启停',
    'menu.groupHint.build': '构建 · Docker · 发布',
    'menu.groupHint.tools': 'nginx · 备份 · 后台',
    'menu.devDesktop': '桌面开发',
    'menu.hint.devDesktop': 'SQLite + Electron',
    'menu.devWeb': '管理后台 + API',
    'menu.hint.devWeb': 'web/ 开发',
    'menu.devLocalWeb': '本地 Web',
    'menu.hint.devLocalWeb': '浏览器 + SQLite',
    'menu.initLocal': 'SQLite 初始化',
    'menu.hint.initLocal': '无需 Docker',
    'menu.themeList': '列出主题',
    'menu.hint.themeList': 'theme list',
    'menu.pluginList': '列出插件',
    'menu.hint.pluginList': 'plugin list',
    'menu.dbBackup': '备份数据库',
    'menu.hint.dbBackup': 'mysqldump',
    'menu.tip': '提示：上下方向键选择，回车确认，Ctrl+C 退出。',
    'menu.shortcuts': '↑/↓ 选择  ·  1-9 快捷  ·  回车确认  ·  Ctrl+C 退出',
    ...
    'dev.autoLocalNoDocker': 'Docker 不可用，已自动切换为本地 SQLite 模式（无需 MySQL）',
    'dev.autoLocalNoMysql': 'MySQL 未就绪，已自动切换为本地 SQLite 模式',
    ...
    'doctor.dockerSkipped': '无需 Docker（SQLite 本地模式）',
    ...
    'doctor.apiFixInit': '运行 reactpress init 启动 API',
    'doctor.pnpmBad': '未检测到 pnpm',
    'doctor.pnpmFix': 'npm i -g pnpm，或在 monorepo 根目录使用 corepack enable',
    'doctor.pnpmSkipped': 'pnpm 可选（独立项目 / 内置运行时）',
    'doctor.check.config': '配置文件',
    'doctor.check.env': '环境变量',
    'doctor.check.ports': '端口',
    'doctor.check.database': '数据库',
    'doctor.check.api': 'API 健康',
    'doctor.check.site': '访客站点',
    'doctor.check.admin': '管理后台',
    'doctor.siteOk': '站点可访问 {url}',
    'doctor.siteBad': '站点不可访问 {url}',
    'doctor.siteFix': '运行 reactpress init 启动主题前台',
    'doctor.adminOk': '后台可访问 {url}',
    'doctor.adminBad': '后台不可访问 {url}',
    'doctor.adminFix': '运行 reactpress init 后访问 {url}',
    ...
    'doctor.logsHint': '提示：运行 reactpress logs --tail 100 查看 API 错误日志',
    'logs.title': 'ReactPress 日志',
    'logs.subtitle': 'API 日志查看',
    'doctor.logs.title': 'ReactPress 日志',
    'doctor.logs.subtitle': 'API 日志查看',
    'doctor.logs.dir': '日志目录  {path}',
    'doctor.logs.empty': '尚未找到 API 日志文件。',
    'doctor.logs.emptyHint':
      '运行 reactpress init 启动 API 后，日志写入 .reactpress/logs/server/（PM2 输出：pm2-out.log / pm2-error.log）',
    'doctor.logs.listHeader': '可用日志文件',
    'doctor.logs.fileHeader': '{file}（显示 {count} 行）',
    ...
    'doctor.logs.pm2Supervised': 'API 由 PM2 托管（pid {pid}）',
    'doctor.logs.pm2Unavailable': '无法使用 PM2 实时输出日志。',
    'doctor.logs.followWindows': '当前环境不支持持续跟踪，请直接打开：{path}',
    'doctor.logs.pidRunning': 'API 进程 pid {pid}（记录在 {path}）',
    'doctor.logs.pidStale': 'pid 文件 {path} 中的 {pid} 已失效（进程未运行）',
    'doctor.logs.moreHint':
      '可用 --tail、--source、--grep、--follow、--list 进一步筛选（见 reactpress logs --help）',
    ...
    'lifecycle.apiExitedEarly': '[reactpress] API 进程已提前退出 (pid {pid})',
    'lifecycle.apiReady': '[reactpress] API 已就绪: {url}',
    'lifecycle.clientStopped': '[reactpress] 已停止站点进程 (pid {pid})',
    'lifecycle.stopClientPidFailed': '[reactpress] 停止站点 pid {pid} 失败:',
    'lifecycle.clientAlreadyRunning': '[reactpress] 站点已在运行 (pid {pid})',
    'lifecycle.clientPidMissing': '[reactpress] 站点启动失败（未记录 pid）',
    'lifecycle.waitingClient': '等待站点就绪 {url}…',
    'lifecycle.clientTimeout': '[reactpress] 站点在 180s 内未就绪: {url}',
    'lifecycle.clientExitedEarly': '[reactpress] 站点进程已提前退出 (pid {pid})',
    'lifecycle.clientReady': '[reactpress] 站点已就绪: {url} (pid {pid})',
    ...
    'lifecycle.processSupervisorFallback':
      '[reactpress] 进程守护不可用 — 已回退到后台 Node 启动',
