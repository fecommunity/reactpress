...
const STRINGS = {
  en: {
    ...
    'cli.help.doctorLogs': '  reactpress doctor logs       Tail API logs for quick debugging',
    ...
    'init.label.api': 'API',
    'init.hint': 'Admin login: admin / admin · Press Ctrl+C to stop',
    'init.apiOnlyHint':
      'API is running. Install a theme in Admin → Appearance to enable the public site.',
    'init.unknownCommand': 'Unknown command: {cmd}',
    'init.useInitOnly': 'ReactPress 4 supports: reactpress init · reactpress doctor',
    ...
    'doctor.logsHint':
      'Tip: run reactpress doctor logs --tail 100 to inspect API error logs',
    'doctor.logs.title': 'ReactPress Doctor · Logs',
    ...
    'doctor.logs.moreHint':
      'Use --tail, --source, --grep, or --list for more control (see reactpress doctor logs --help)',
  ...
  zh: {
    ...
    'cli.help.doctorLogs': '  reactpress doctor logs       查看 API 日志，快速定位问题',
    ...
    'init.label.admin': '后台',
    'init.label.api': 'API',
    'init.hint': '后台账号：admin / admin · 按 Ctrl+C 停止',
    'init.apiOnlyHint': 'API 已运行。请在管理后台「外观 → 主题」安装主题以启用访客站。',
    'init.unknownCommand': '未知命令：{cmd}',
    'init.useInitOnly': 'ReactPress 4 支持：reactpress init · reactpress doctor',
    ...
    'doctor.logsHint': '提示：运行 reactpress doctor logs --tail 100 查看 API 错误日志',
    'doctor.logs.title': 'ReactPress Doctor · 日志',
    ...
    'doctor.logs.moreHint':
      '可用 --tail、--source、--grep、--list 进一步筛选（见 reactpress doctor logs --help）',
