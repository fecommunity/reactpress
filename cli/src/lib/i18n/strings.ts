...
const STRINGS = {
  en: {
    ...
    'cli.logs.description': 'View recent API logs (error, request, response)',
    'cli.logs.descriptionAlias': 'View API logs (alias of reactpress logs)',
    'cli.logs.tailOption': 'Number of lines to show per log file',
    'cli.logs.sourceOption': 'Log source: error, request, response, or all',
    ...
    'doctor.logs.emptyHint':
      'Start the API with reactpress init — logs are written to .reactpress/logs/server/',
    ...
    'doctor.logs.moreHint':
      'Use --tail, --source, --grep, or --list for more control (see reactpress logs --help)',
  ...
  zh: {
    ...
    'cli.logs.description': '查看 API 日志（error / request / response）',
    'cli.logs.descriptionAlias': '查看 API 日志（同 reactpress logs）',
    'cli.logs.tailOption': '每个日志文件显示的行数',
    'cli.logs.sourceOption': '日志类型：error、request、response 或 all',
    ...
    'doctor.logs.emptyHint': '运行 reactpress init 启动 API 后，日志会写入 .reactpress/logs/server/',
    ...
    'doctor.logs.moreHint':
      '可用 --tail、--source、--grep、--list 进一步筛选（见 reactpress logs --help）',
