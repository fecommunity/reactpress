  ...
  return (
    ...
    />
      ...
      <style jsx>{`
        ...
        .tags-cloud :global(.tag-link::before) {
          content: '';
          position: absolute;
          top: 0;
          left: 0;
        ...
        .tags-cloud :global(.tag-link:hover),
        .tags-cloud :global(.tag-link.active) {
        ...
        .tags-cloud :global(.tag-link:hover::before),
        .tags-cloud :global(.tag-link.active::before) {
          opacity: 1;
        }
