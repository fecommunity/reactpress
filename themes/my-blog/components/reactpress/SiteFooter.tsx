    ...
    <footer className="mt-10 w-full border-t border-[var(--border-color)] bg-[var(--bg-box)] py-8" role="contentinfo">
      ...
      <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex shrink-0 items-center gap-4">
          <a href="/rss" target="_blank" rel="noopener noreferrer" aria-label="rss" className="text-[var(--main-text-color)] hover:text-[var(--primary-color)]">
          ...
          {setting?.aboutUsGithubUrl?.trim() ? (
            <a
              ...
              aria-label="Github"
              className="text-[var(--main-text-color)] hover:text-[var(--primary-color)]"
            >
