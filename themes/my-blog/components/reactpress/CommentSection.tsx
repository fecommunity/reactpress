...
import CommentEditor from '@/components/reactpress/comment/CommentEditor';
import { CommentList } from '@/components/reactpress/comment/CommentItem';
import { CommentProvider } from '@/src/providers';
import { COMMENT_DOM_ID, type CommentNode } from '@/src/utils/comment';
...
export default function CommentSection({ hostId }: CommentSectionProps) {
  ...
  const {
    ...
    setPage,
    refresh,
  } = usePagination<CommentNode>(
    (params) => CommentProvider.getArticleComments(hostId, params),
    {
      pageSize: 6,
