...
- **Plugins** ([#69](https://github.com/fecommunity/reactpress/issues/69)): Hook system, `plugin.json` manifest, Admin slots; built-in `hello-world`, `seo`, `image-optimizer`
- **Desktop** ([#70](https://github.com/fecommunity/reactpress/issues/70)): Electron + SQLite local mode; remote API + sync to server
- **Themes** ([#71](https://github.com/fecommunity/reactpress/issues/71)): npm catalog (`theme-starter`), `theme add`/`list`, preview pool; hello-world docs refresh
