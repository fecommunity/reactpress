      ...
      <main className="main">
        <div className="content-wrapper">
          <div className="page-header">
            <h1 className="page-title">Tag: {tagName}</h1>
            <p className="page-description">
              {safeArticles.length} article{safeArticles.length !== 1 ? 's' : ''} with this tag
            </p>
          </div>
          ...
          <div className="content-layout">
            ...
            <aside className="sidebar">
              <div className="sidebar-widget">
                ...
                <TagsCloud tags={safeTags} currentTag={tag} />
              </div>
            </aside>
          </div>
        </div>
...
export const getStaticPaths: GetStaticPaths = async () => {
  // In a real implementation, you would fetch all tags
...
export const getStaticProps: GetStaticProps<TagProps> = async ({ params }) => {
  try {
    ...
    // Fetch articles for this tag and all tags
    // Cast to any to access the actual response data
    const [articlesResponse, tagsResponse] = await Promise.all([
      themeApi.article.findArticlesByTag(tag) as any,
      themeApi.tag.findAll() as any,
    ]);
